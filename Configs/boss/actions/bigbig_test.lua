...
while true do
    ...
    pw_collider = collider.square(attack_position, attack_radius)
    pw = parryWindow(attack_position, pw_collider, function() return true end)
    pw_t = timer(1 * scale)
    ...
    branch:onEnd(function() warning_animation:cancel() end)
